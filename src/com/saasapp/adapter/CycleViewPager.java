...
public class CycleViewPager extends ViewPager {
	...
	public LinearLayout indicatorLayout; // 主题指示器
	...
	public void setAdapter(PagerAdapter arg0) {
		indicators = new ImageView[arg0.getCount()];
		mAdapter = new InnerPagerAdapter(arg0);
		mAdapter.setIndicators(0);
	...
	private class InnerOnPageChangeListener implements OnPageChangeListener {
		...
		public void onPageSelected(int arg0) {
			position = arg0;
			int showIndicators = 0;
			if (arg0 == mAdapter.getCount() - 1) {
				showIndicators = 0;
			} else if (arg0 == 0) {
				showIndicators = mAdapter.getCount() - 3;
			} else {
				showIndicators = arg0 - 1;
			}
			indicatorLayout.removeAllViews();
			mAdapter.setIndicators(showIndicators);
			if (null != listener) {
	...
	private class InnerPagerAdapter extends PagerAdapter {
		...
		public void setIndicators(int showIndicator)
		{
